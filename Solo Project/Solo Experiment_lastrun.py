...
expName = 'Solo Experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\nandi\\OneDrive\\Desktop\\Ongoing Subjects\\PSY310\\Solo Project\\Solo Experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    instruction = visual.TextStim(win=win, name='instruction',
        text='Try to remember the words as they appear on the screen. You will be asked to recall them later. Press "space" to begin.',
        font='Arial',
    ...
    instruction_2 = visual.TextStim(win=win, name='instruction_2',
        text='You will now see incomplete numerical sequences. Your task is to identify the next number in the sequence and type it in the box. After typing, click Submit. Press "space" to begin.',
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Now the recall task will begin.',
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    instruction_3 = visual.TextStim(win=win, name='instruction_3',
        text="Please type as many words as you can remember from the list, one at a time. After typing each word, click Submit. If you can't remember any words, leave the space blank or type any word that comes to mind and click Submit.",
        font='Arial',
        pos=(0, 0.3), height=0.05, wrapWidth=None, ori=0.0, 
        color=[-1.0000, -1.0000, -1.0000], colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    for thisTrial in trials:
        ...
        win.color = EncodingColour  # This sets the background color
        text.setText(Word)
        # keep track of which components have finished
        EncodingComponents = [fixation, text]
    ...
    win.color = "gray"  # Sets a neutral gray background
    # create starting attributes for key_resp_2
    key_resp_2.keys = []
    key_resp_2.rt = []
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    instructions_2Components = [instruction_2, key_resp_2]
    ...
    for thisTrial_2 in trials_2:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Distractors.started', globalClock.getTime(format='float'))
        distractor.setText(Sequence)
        textbox.reset()
        # reset button to account for continued clicks & clear times on/off
        button.reset()
        # keep track of which components have finished
        DistractorsComponents = [fixation_2, distractor, textbox, button]
        ...
        for thisComponent in DistractorsComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Distractors.stopped', globalClock.getTime(format='float'))
        ...
        # the Routine "Distractors" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('disclaimer.started', globalClock.getTime(format='float'))
    # keep track of which components have finished
    disclaimerComponents = [text_2]
    ...
    for thisComponent in disclaimerComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('disclaimer.stopped', globalClock.getTime(format='float'))
    # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
    if routineForceEnded:
        routineTimer.reset()
    else:
    ...
    for thisTrial_3 in trials_3:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Retrieval.started', globalClock.getTime(format='float'))
        # Run 'Begin Routine' code from code_3
        win.color = RecallColour  # Set the background color dynamically
        textbox_2.reset()
        # reset button_2 to account for continued clicks & clear times on/off
        button_2.reset()
        # keep track of which components have finished
        RetrievalComponents = [fixation_3, instruction_3, textbox_2, button_2]
        ...
        while continueRoutine:
            ...
            if instruction_3.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
            ...
            if textbox_2.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
        ...
        for thisComponent in RetrievalComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Retrieval.stopped', globalClock.getTime(format='float'))
        trials_3.addData('textbox_2.text',textbox_2.text)
        trials_3.addData('button_2.numClicks', button_2.numClicks)
        if button_2.numClicks:
           trials_3.addData('button_2.timesOn', button_2.timesOn)
           trials_3.addData('button_2.timesOff', button_2.timesOff)
        else:
           trials_3.addData('button_2.timesOn', "")
           trials_3.addData('button_2.timesOff', "")
