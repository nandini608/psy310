...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\nandi\\OneDrive\\Desktop\\Ongoing Subjects\\PSY310\\Orientation Discrimination Task\\Tutorial 2_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Press the up arrow key if the grating is vertically postioned, and the down arrow key if you notice a tilt.\n\nPress space to begin.',
        font='Arial',
    ...
    instructionComponents = [key_resp_2, text]
