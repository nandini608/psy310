...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\nandi\\OneDrive\\Desktop\\Ongoing Subjects\\PSY310\\Word Priming Experiment\\Tutorial 5_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('studyphase.csv'),
    ...
    for thisTrial in trials:
        ...
        thisExp.addData('study.started', globalClock.getTime(format='float'))
        ...
        thisExp.addData('study.stopped', globalClock.getTime(format='float'))
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('testphase.csv'),
    ...
    for thisTrial_2 in trials_2:
        ...
        while continueRoutine:
            ...
            if Testtext.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > Testtext.tStartRefresh + 10.0-frameTolerance:
                    # keep track of stop time/frame for later
