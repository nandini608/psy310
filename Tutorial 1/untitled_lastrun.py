...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\nandi\\OneDrive\\Desktop\\Ongoing Subjects\\PSY310\\Tutorial 1\\untitled_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Press the left or the right arrow key depending on the grating's tilt.\n\nPress space to begin the task.",
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        thisExp.addData('key_rep.corr', key_resp.corr)
